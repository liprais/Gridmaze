...
const RELIC_EN: Record<string, string | RelicTranslation> = {
  ...
  chapterFailedTitle: 'Stability Collapsed',
  chapterFailedSubtitle: 'Your stability has run out. The chapter resets.',
  chapterFailedHint: 'Press any key to restart',
...
const RELIC_ZH: Record<string, string | RelicTranslation> = {
  ...
  chapterFailedTitle: '稳定度崩塌',
  chapterFailedSubtitle: '稳定度耗尽。本章将重置。',
  chapterFailedHint: '按任意键继续',
...
const translations: { en: TranslationSet; zh: TranslationSet } = {
  en: {
    ...
    log: {
      ...
      coreCollected: 'Core collected! +1',
      proximity: [
